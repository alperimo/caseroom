...
const manifest = {
  ...
  track: process.env.CASE_ROOM_HACKATHON_TRACK ?? "General Purpose",
  ...
  manualArtifactsExpected: [
    "demo-video.mp4",
    "hardware-photo-or-screen-recording",
  ...
  notes: [
    ...
    "If qvac-health.json shows fallback/unavailable models, restart npm run dev and rerun this script."
  ]
};
